*
* HippelTFMX normal Replay / adapted by Vampire of PseudoDOS Group
* ----------                            -------
*
* call h_initsmpl (a0=modadr) once to init the samples
* call h_control (d0=nr1-x) to start subsong nr1-x
* call h_replay each vertical blank to play the song
* call h_stop to stop the song and to turn off the audioDMA (nooo!!!)
*

;>extern"dh0:music/hipp.cybernoidII",modadr
...
h_initsmpl	cmp.l	#"TFMX",(a0)
		beq.s	h_found
		addq.l	#2,a0
		bra.s	h_initsmpl
h_found		BSET	#1,$00BFE001.L
